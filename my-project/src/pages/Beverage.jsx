...
const beverageProducts = [
    {
        ...
        desc: "Freshly squeezed orange juice, full of vitamin C.",
        price: "$2.99/litre",
    },
    {
        name: "Coffee",
        image: "https://images.unsplash.com/photo-1465101178521-c1a9136a3b41?auto=format&fit=crop&w=400&q=80",
        desc: "Rich, aromatic coffee to energize your day.",
        price: "$3.49/250g",
    },
    {
        name: "Green Tea",
        image: "https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=400&q=80",
        desc: "Refreshing green tea, packed with antioxidants.",
        price: "$2.19/box",
    },
    {
        name: "Milkshake",
        ...
        <div className="min-h-screen bg-yellow-50 flex flex-col">
            ...
            <nav className="bg-yellow-300 px-6 py-4 flex justify-between items-center shadow">
                ...
                <div className="flex items-center gap-6 text-base font-medium">
                    ...
                    <a href="#" className="text-blue-700 font-semibold">Beverage</a>
            ...
            <section className="flex flex-col items-center justify-center text-center py-10 px-4 bg-yellow-50">
                <h1 className="text-4xl md:text-5xl font-extrabold text-yellow-800 mb-3">Refreshing Beverages</h1>
                <p className="text-lg text-gray-700 mb-4 max-w-xl">
                    Quench your thirst with our selection of fresh and delicious beverages for every taste.
                </p>
            </section>

            {/* Beverage Grid */}
            <section className="max-w-6xl mx-auto w-full p-4 flex-1">
                <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Available Beverages</h2>
