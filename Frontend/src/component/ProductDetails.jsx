...
export default function Productdetails() {
    ...
    useEffect(() => {
        axios.get(`${import.meta.env.VITE_BASE_URL}/api/products/name/${name}`)
            .then(res => {
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        ...
                        <div className="p-8 lg:p-12">
                            ...
                            <div>
                                <button
                                    onClick={() => handleAddToCart(product._id)} className="w-full bg-yellow-500 text-white px-6 py-4 rounded-xl font-semibold text-lg hover:bg-yellow-600 transform transition duration-300 hover:scale-105 shadow-lg">🛒 Add to Cart - ${quantity * product.price}</button>
